...
reg_data <- reg_data %>% dplyr::select(prix_euros , brand, carrosserie, energie, transmission, is_pro, kilometrage_km, nb_portes, hayon)
...
reg_sol <- lm(log(prix_euros)  ~ energie + transmission+is_pro+kilometrage_km+nb_portes+hayon , data_reg) #We log as price is skewed, yet it is gaussion when logged
