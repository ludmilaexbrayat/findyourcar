...
coef_function <- function(carrosserie, df){
  ...
  coef_0 <- regression_function(df, carrosserie)$coef[1]
  coef_essence <- regression_function(df, carrosserie)$coef[3]
  coef_hybride <- regression_function(df, carrosserie)$coef[5]
  coef_manuelle <- regression_function(df, carrosserie)$coef[7]
  coef_semi_auto <- regression_function(df, carrosserie)$coef[8]
  coef_is_pro <- regression_function(df, carrosserie)$coef[9]
  coef_kilom <- regression_function(df, carrosserie)$coef[10]
