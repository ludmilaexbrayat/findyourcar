...
<br>
Before going further, let's define what we want.<br>
...
* _city_
* _street_
* _id_listing_: the id used by the website
* _website_: the website where we found the listing
* _url_: the url of the listing
