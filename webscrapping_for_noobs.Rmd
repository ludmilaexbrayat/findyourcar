...
list_searchengine_urls_1 <- read.csv("Datasets/list_links_searchengine_1.csv", stringsAsFactors = FALSE)

## Scrapping the list
scrapped_listings <- rbind.fill(lapply(list_searchengine_urls_1$x[1:500], scrap_listing))
