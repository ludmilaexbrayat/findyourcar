...
data$month_year <- sapply(data$Année, function(x) str_remove(x, "\nAssurance auto : Comparez"), USE.NAMES = F)

# Make a date format of month + year, for only year we take january

#data$year <- 
#sapply(data$month_year, function(x) str_match(x, "[1-2]([9]|[0-1])[0-9]{2}")[1], USE.NAMES = F)
```
