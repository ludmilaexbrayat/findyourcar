...
#todo: be careful with the new "marque column I dont understand"
...
data$city_pro <- sapply(data$address_pro, get_city_pro, USE.NAMES = F)

# Remplacer par : map(data$address_pro, ~get_city_pro(.x))
